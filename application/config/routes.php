...
$route['master-kustomer/jsonpel']='MasterKustomer/jsonpel';
...
$route['penjualan-input']='PenjualanInput';
$route['penjualan-input/loadbm']='PenjualanInput/loadbm';
$route['penjualan-input/simpan-barang-baru']='PenjualanInput/addmb';
$route['penjualan-input/hapus/(:num)'] = 'PenjualanInput/deletepost/$1';
